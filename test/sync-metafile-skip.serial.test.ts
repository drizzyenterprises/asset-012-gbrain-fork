...
describe('#1433 — re-sync preserves previously-indexed metafile pages', () => {
  ...
  test('ops/** page indexed via direct putPage survives re-sync after file edit (pruned-dir guard, estate #86)', async () => {
    // Bug class (estate PRJ-2026-032 #86): `ops` is in PRUNE_DIR_NAMES, so
